    ...
    <div class="container">
        ...
        <div class="wrp">
            <form id="MyForm" action="action.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="daya">Daya awal:</label>
                    <input class="form-control" id="daya" name="daya" required>
                </div>
                <div class="form-group">
                    <label for="daya_baru">Daya baru:</label>
                    <input class="form-control" id="daya_baru" name="daya_baru" required>
                </div>
                <div class="form-group">
                ...
                <div class="show">
                    <button class="btn btn-secondary" onclick="location.href='regist.php'">BACK</button>
                </div>
            </form>
        </div>
    </div>
